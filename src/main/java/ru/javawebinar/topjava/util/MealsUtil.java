...
public class MealsUtil {
    ...
    private static List<MealTo> filteredByRecursion(List<Meal> meals, LocalTime startTime, LocalTime endTime,
                                                    int caloriesPerDay) {
    ...
    private static List<MealTo> filteredBySetterRecursion(List<Meal> meals, LocalTime startTime, LocalTime endTime,
                                                          int caloriesPerDay) {
        class MealNode {
    ...
    public static List<MealTo> filteredByRecursionWithCycleAndRunnable(List<Meal> meals, LocalTime startTime,
    ...
    /*
        private static List<MealTo> filteredByAtomic(List<Meal> meals, LocalTime startTime, LocalTime endTime,
        int caloriesPerDay) {
            Map<LocalDate, Integer> caloriesSumByDate = new HashMap<>();
        ...
        private static List<MealTo> filteredByReflection(List<Meal> meals, LocalTime startTime, LocalTime endTime,
        int caloriesPerDay) throws NoSuchFieldException, IllegalAccessException {
            Map<LocalDate, Integer> caloriesSumByDate = new HashMap<>();
        ...
        private static List<MealTo> filteredByClosure(List<Meal> mealList, LocalTime startTime, LocalTime endTime,
        int caloriesPerDay) {
            final Map<LocalDate, Integer> caloriesSumByDate = new HashMap<>();
            List<MealTo> mealsTo = new ArrayList<>();
    ...
    */
    ...
    private static List<MealTo> filteredByExecutor(List<Meal> meals, LocalTime startTime, LocalTime endTime,
    ...
    public static List<MealTo> filteredByLock(List<Meal> meals, LocalTime startTime, LocalTime endTime,
                                              int caloriesPerDay) throws InterruptedException {
        Map<LocalDate, Integer> caloriesSumByDate = new HashMap<>();
        List<MealTo> mealsTo = new ArrayList<>();
    ...
    private static List<MealTo> filteredByCountDownLatch(List<Meal> meals, LocalTime startTime, LocalTime endTime,
                                                         int caloriesPerDay) throws InterruptedException {
        Map<LocalDate, Integer> caloriesSumByDate = new HashMap<>();
    ...
    public static List<MealTo> filteredByConsumerChain(List<Meal> meals, LocalTime startTime, LocalTime endTime,
                                                       int caloriesPerDay) {
    ...
    private static List<MealTo> filteredByFlatMap(List<Meal> meals, LocalTime startTime, LocalTime endTime,
                                                  int caloriesPerDay) {
    ...
    private static List<MealTo> filteredByCollector(List<Meal> meals, LocalTime startTime, LocalTime endTime,
                                                    int caloriesPerDay) {
